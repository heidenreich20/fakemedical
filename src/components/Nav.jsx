  ...
  return (
    <nav className='sticky top-0 z-20 bg-neutral-50/[0.95] shadow-md shadow-neutral-500/[0.3]'>
      <div className='flex lg:justify-center justify-between lg:px-0 px-5 items-center gap-8 lg:gap-16 xl:gap-32 h-20'>
        ...
        <a href='#contactForm' className='text-neutral-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-700 outline-offset-4 md:block hidden box-content font-semibold bg-sky-700 p-2 xl:p-3 px-6 xl:px-12 rounded-md'>Pide tu cita</a>
      </div>
